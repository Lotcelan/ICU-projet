...
int main(int argc, char **argv) {
   ...
   // ./main 288 5 7.5 5 5 50 1256 30.03 10 10 10 0 10 "air_temp.tipe" "air_temp_last_first.tipe" "masses_temp_last_first.tipe" 0
    ...
    simulation(T_e, Vitesse_air, Volume_air, L, l, n, c_p, D, config_l_wall_temp, config_floor_temp, config_r_wall_temp, config_l_wall_h, config_floor_h, config_r_wall_h, (bool)continuer_meme_si_fini, nb_it_supp, save_air_temp_filename, air_temp_last_first_file, masses_temp_last_first_file, (bool)flask, (bool)print_to_file);
